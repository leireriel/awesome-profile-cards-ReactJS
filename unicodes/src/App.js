      ...
      <div className="home__container">
        <div className="home__container2">
          ...
          <main className="home">
            <div className="home__wrapper home__main-wrapper">
              ...
              <h2 className="home__subtitle">Crea mejores contactos profesionales de forma fácil y cómoda</h2>
              <ul className="home__list">
                <li className="home__list-item"> 
                  <i className="home__list-image far fa-object-ungroup"></i>
                  <p className="home__list-text">Diseña</p>
                </li>
                <li className="home__list-item"> 
                  <i className="home__list-image far fa-keyboard"></i>
                  <p className="home__list-text">Rellena</p>
                </li>
                <li className="home__list-item"> 
                  <i className="home__list-image fas fa-share-alt"></i>
              ...
              href="card.html">
                <span 
                className="home__button-text">Comenzar
                </span>
              </a>
            </div>
          </main>
        ...
        <footer className="main__footer">
          <div className="home__wrapper main__footer-wrapper">
            <p className="main__footer-copy">Awesome profile-cards &copy;2019</p> 
            <a 
