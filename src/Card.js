                            ...
                            <div className="design__container__form js-container-panel">
                                ...
                                <div>
                                    <div className="design__form design__form-blue">
                                        ...
                                        className="radio_btn"/>
                                        <ul className="theme">
                                            <li className="theme__color" style="background-color: #114e4e"></li>
                                            <li className="theme__color" style="background-color: #438792"></li>
                                            <li className="theme__color" style="background-color: #a2deaf"></li>
                                        </ul>
                                    </div>
                                    <div className="design__form design__form-red">
                                        ...
                                        className="radio_btn"/>
                                        <ul className="theme">
                                            <li className="theme__color" style="background-color:#420101"></li>
                                            <li className="theme__color" style="background-color:#bd1010"></li>
                                            <li className="theme__color" style="background-color:#e95626"></li>
                                        </ul>
                                    </div>
                                    <div className="design__form design__form-grey">
                                        ...
                                        className="radio_btn"/>
                                        <ul className="theme">
                                            <li className="theme__color" style="background-color:#3e5b65"></li>
                                            <li className="theme__color" style="background-color:#dfe5eb"></li>
                                            <li className="theme__color" style="background-color:#a0c0cf"></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
