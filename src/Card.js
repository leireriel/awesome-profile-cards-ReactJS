        ...
        <header className="card__header">
          <div className="wrapper card__header">
            <a href="index.html">
              ...
              src="assets/images/logo_GameOfCodes.svg"
              alt="Ir a la home"/>
            </a>
          </div>
        </header>
              ...
              <fieldset className="design js-container">
                ...
                <div className="design__container__title js-container-title">
                  <div className="design__container__title1">
                    <i className="design__icon far fa-object-ungroup"></i>
                    <h2 className="design__title">DISEÑA</h2>
                  </div>
                  <div className="design__container__title2 container-arrow">
                    <i className="fas fa-chevron-up design__img-arrow"></i>
                  </div>
                </div>
                <div className="design__container__form js-container-panel">
                  ...
                  <div>
                    <div className="design__form design__form-blue">
                      ...
                      className="radio_btn"/>
                      <ul className="theme">
                        <li className="theme__color" style={{backgroundColor: "#114e4e"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#438792"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#a2deaf"}}></li>
                      </ul>
                    </div>
                    <div className="design__form design__form-red">
                      <label
                      className="hide"
                      for="red_palette">Red palette
                      </label>
                      <input
                      id="red_palette"
                      type="radio"
                      ...
                      className="radio_btn"/>
                      <ul className="theme">
                        <li className="theme__color" style={{backgroundColor: "#420101"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#bd1010"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#e95626"}}></li>
                      </ul>
                    </div>
                    <div className="design__form design__form-grey">
                      <label
                      className="hide"
                      for="grey_palette">grey palette
                      </label>
                      <input
                      id="grey_palette"
                      type="radio"
                      ...
                      className="radio_btn"/>
                      <ul className="theme">
                        <li className="theme__color" style={{backgroundColor: "#3e5b65"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#dfe5eb"}}></li>
                        <li className="theme__color" style={{backgroundColor: "#a0c0cf"}}></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <fieldset className="section__fill js-container js-container-hidden">
                ...
                <div className="fill__container-title js-container-title">
                  <div className="fill__container_img-keyboard">
                    <i className="far fa-keyboard fill__img-keyboard"></i>
                  </div>
